    ...
    <body class=" login_page" style="background-color: #0f1223; background-image: none;">
        ...
        <div class="login-wrapper">
            <div id="login" class="login loginpage offset-xl-4 col-xl-4 offset-lg-3 col-lg-6 offset-md-3 col-md-6 col-offset-0 col-12">
                ...
                <form name="loginform" id="loginform" action="ui-loginform.php" method="post">
                    <p>
                        <label for="user_login">Username<br />
                            <input type="text" id="user_login" class="input" placeholder="Username" size="20" name="userName" required/></label>
                    </p>
                    <p>
                        <label for="user_pass">Password<br />
                            <input type="password" id="user_pass" class="input" placeholder="Password" size="20" name="password" required /></label>
                    </p>

                    <p class="submit">
                        <input type="submit" name="wp-submit" id="wp-submit" class="btn btn-block" style="background: #ff30b8" value="Sign In" />
                    </p>
                </form>

                <p id="nav">
                    <a class="float-left" href="#" title="Password Lost and Found">Forgot password?</a>
                    <a class="float-right" href="ui-register.php" title="Sign Up">Sign Up</a>
                </p>
